...
public class ForgotPassword implements ActionListener
{
    ...
    ForgotPassword()
    {
        ...
        ImageIcon img=new ImageIcon("src\\societymanagementsystem\\images\\remove.jpg");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==bcheck)
        {
            try
            {
                ...
                String str = "select * from adminlogin where KEYID ='"+s+"';";
        ...
        if(ae.getSource()==bchange)
        {
            ...
            try
            {
                ...
                {
                    String str1="update adminlogin set PASSWORD='"+newpassword+"',KEYID= '"+newkeyid+"';";
                    c.s.executeUpdate(str1);
                    String str2="select * from adminlogin;";
